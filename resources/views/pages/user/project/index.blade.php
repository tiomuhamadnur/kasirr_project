            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required">License</label>
                            <select class="form-select" name="license_id" id="license_id_edit" required>
                                <option value="" selected disabled>- select option -</option>
                                @foreach ($license as $item)
                                    <option value="{{ $item->id }}">{{ $item->key }}
                                        ({{ $item->status->name ?? '-' }})</option>
    ...
    <script>
        $(document).ready(function() {
            $('#editModal').on('show.bs.modal', function(e) {
                ...
                var license_id = $(e.relatedTarget).data('license_id');
                ...
                $('#license_id_edit').val(license_id);
            });
        });
    </script>
@endsection
