...
class ProjectDataTable extends DataTable
{
            ...
            ->addColumn('#', function ($item) {
                ...
                $actionButton = "<div class='dropdown'>
                                ...
                                <div class='dropdown-menu dropdown-menu-end'>
                                    <a class='dropdown-item' href='#' data-bs-toggle='modal' data-bs-target='#editModal' data-url='{$editRoute}' data-name='{$item->name}' data-code='{$item->code}' data-description='{$item->description}' data-group_id='{$item->group_id}' data-license_id='{$item->license_id}'>
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('license.category.name')->title('Category'),
